...
typedef pa_stream *(__cdecl *pa_stream_new)(pa_context *c, const char *name, const pa_sample_spec *ss, const pa_channel_map *map);
...
typedef int(__cdecl *pa_stream_connect_playback)(pa_stream *s, const char *dev, const pa_buffer_attr *attr, pa_stream_flags_t flags, const pa_cvolume *volume, pa_stream *sync_stream);
typedef int(__cdecl *pa_stream_disconnect)(pa_stream *s);
typedef int(__cdecl *pa_stream_cancel_write)(pa_stream *p);
typedef int(__cdecl *pa_stream_write)(pa_stream *p, const void *data, size_t nbytes, pa_free_cb_t free_cb, int64_t offset, pa_seek_mode_t seek);
