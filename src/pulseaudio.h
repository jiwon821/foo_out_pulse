...
// Patched functions from jiwon821/libpulse as they were in the original
// foo_out_pulse sources. I'm not enough of a C++ programmer to know
// whether there's a better way to do this, but at least this works.
